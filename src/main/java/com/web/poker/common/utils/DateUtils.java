...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String todayToStringMD() {
	...
	public static String formatDateCode(Date date) {
	...
	public static Date parseDateCode(String date) throws ParseException {
	...
	public static String diffTime(Date end, Date start) {
		if (start == null) {
			start = new Date();
		}
		long t = (end.getTime() - start.getTime())/1000;
		int days = (int)t / (3600 *24);
		int hours = (int) t % (3600 *24) / 3600;
	...
	* @throws
	...
	public static void main(String[] args) throws ParseException {
		...
		//System.out.println(getDateByDay(-30));
	}
}
